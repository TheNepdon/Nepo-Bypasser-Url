...
bot_token = getenv("8730076477:AAFOkUPuwOSYfgxCDGuXJUtBOzJOpr-bIUo")
api_hash = getenv("836f930f25641f55017320b77c60fa7d")
api_id = getenv("27382104")
...
def loopthread(message: Message, otherss=False):
    ...
    if bypasser.ispresent(bypasser.ddl.ddllist, urls[0]):
        ...
        if "https://olamovies" in urls[0] or "https://psa.wf/" in urls[0]:
            ...
            msg: Message = app.send_message(
                message.chat.id, "🔎 __processing...__", reply_to_message_id=message.id
            )
...
def send_start(client: Client, message: Message):
    app.send_message(
        message.chat.id,
        f"__👋 Hi **{message.from_user.mention}**, I am Link Bypasser Bot developed by NepDon Exploits just send me any supported links and I will get you results.\nCheckout /help to Read More__",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🌐 Channel 1",
                        url="https://t.me/+8xex0a9HoKs0OTZl",
                    )
                ],
                [
                    InlineKeyboardButton(
                        "Offical Channel",
                        url="https://t.me/nepourlbypasser",
                    )
                ],
            ]
        ),
